...
import { ArrowRight, DollarSign, Shield, Zap, Globe, TrendingUp, Play } from 'lucide-react';
...
const OKX: React.FC = () => {
  usePageMeta(
    "OKX - Conta em Dólares Sem IOF",
    "Abra sua conta na OKX e opere em dólares digitais sem IOF. Plataforma global de criptomoedas com suporte em português."
  );
